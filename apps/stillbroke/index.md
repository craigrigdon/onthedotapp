...
<div class="actions" markdown="0">
<a class="btn btn-primary" href="{{ "/apps/stillbroke/privacy/" | relative_url }}">Privacy Policy</a>
<a class="btn btn-ghost" href="{{ "/apps/stillbroke/support/" | relative_url }}">Support</a>
</div>

<p class="fineprint" style="margin-top:1.5rem">App Store Connect URLs: <code>https://www.onthedotapp.com/apps/stillbroke/privacy/</code> and <code>https://www.onthedotapp.com/apps/stillbroke/support/</code></p>
